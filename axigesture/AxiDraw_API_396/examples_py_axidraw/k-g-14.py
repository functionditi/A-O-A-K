...
# Grid settings: grid_size = 3, spacing = 50.
...
def serial_only_mode(ad):
    print("Entering serial-only mode. Press 'q' to exit this mode.")
    try:
    ...
    while True:
        ...
        if ser.in_waiting:
            ...
            if line:
                ...
                # Ignore "0"
                send_recent_update_to_axidraw(ad)
        # Small sleep could be added if needed.
    ser.close()
...
def interactive_loop():
    ...
    # Open serial port for Arduino gestures.
    try:
    ...
    while True:
        ...
        if ser and ser.in_waiting:
            ...
            if line:
                ...
                # Ignore "0"
                send_recent_update_to_axidraw(ad)
        # Also check for manual keyboard input.
